...
public class EventCrewResourceIT {
    ...
    public void setup() {
        ...
        final EventCrewResource eventCrewResource = new EventCrewResource(eventCrewService);
        this.restEventCrewMockMvc = MockMvcBuilders.standaloneSetup(eventCrewResource)
