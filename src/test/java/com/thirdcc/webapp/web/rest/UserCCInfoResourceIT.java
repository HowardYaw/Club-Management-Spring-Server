...
public class UserCCInfoResourceIT {
    ...
    public void setup() {
        ...
        final UserCCInfoResource userCCInfoResource = new UserCCInfoResource(userCCInfoService);
        this.restUserCCInfoMockMvc = MockMvcBuilders.standaloneSetup(userCCInfoResource)
